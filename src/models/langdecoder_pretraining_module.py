...
class LangDecoderPretrainingModule(LightningModule):
    def __init__(
            self,
            net: LanguageDecoder,
    ...
    def model_step(self, batch: dict) -> Tuple[torch.Tensor, list, list]:
        ...
        output = self.forward(labels=labels, attention_mask=attention_mask)
...
if __name__ == "__main__":
    _ = LangDecoderPretrainingModule(None, None)
